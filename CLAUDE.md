...
> **🔥 현재 최우선(2026-07-12): E-BOOK 만료 링크 정리(ROADMAP §5-2 = §0 U4).** 단, 48개 전수 점검서 하드 다운(404) 0건 — "소프트 로트"(200인데 특정 책만 내려감)만 남아 응급은 아니며, 확인·교체는 사용자 몫. 나머지 최우선 2개(성적 산출기 v2·계산 단위 테스트)는 ✅ 완료. 상세·다음 순위는 ROADMAP §5.
